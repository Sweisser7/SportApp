...
@Composable
fun ActivityPageContent(modifier: Modifier, navController: NavController, activityViewModel: ActivityViewModel, historyViewModel: HistoryViewModel) {
    val screen = BottomBarScreen.MainPage

    val state by activityViewModel.matchingState.collectAsState()
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(12.dp))
        Row {
            Button(onClick = { activityViewModel.toggleStopWatch() }) {
